...
describe("Particle", () => {
    ...
    it("should call the appropriate functions related to ctx in draw", () => {
        ...
        expect(ctx.arc).toHaveBeenCalledWith(particle.pos.x, particle.pos.y, PARTICLE_SIZE, 0, 2 * Math.PI);
    ...
    it("distance should work successfully", () => {
        ...
        expect(particle.creatureDistance(otherParticle)).toBe(expectedLength);
    })
})